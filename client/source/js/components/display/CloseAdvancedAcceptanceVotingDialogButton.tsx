...
export interface CloseAdvancedAcceptanceVotingDialogButtonProps {
  onRef?: Function;
  onConfirm: Function;
...
export class CloseAdvancedAcceptanceVotingDialogButton extends React.Component<CloseAdvancedAcceptanceVotingDialogButtonProps, any> {
  ...
  render() {
    ...
    const closeAdvancedAcceptanceBookLabelId = 'close-advanced-acceptance-book-label';
        ...
        content={
          <div className='c-close-voting-dialog c-close-voting-dialog--acceptance'>
            ...
            <FormControl className='o-field o-field--dropdown u-space--bot-large'>
              ...
              <Select
                id='new-season-book'
                labelId={closeAdvancedAcceptanceBookLabelId}
                label='Book'
                name='book'
                value={book}
